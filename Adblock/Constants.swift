...
struct Constants {
    ...
    static let filtersSources: [FilterSource] = [
        FilterSource(name: "Block Mobile Ads",
                     ...
                     free: true,
                     imageName: "safari.fill", color: Colors.blueColor, whiteBlackList: false, fileName: "BlockMobileAds"),
        FilterSource(name: "Block Mobile Ads 2",
                     ...
                     description: "Filter blocks mobile ad networks",
                     free: true,
                     imageName: "safari.fill", color: Colors.blueColor, whiteBlackList: false, fileName: "BlockMobileAds2"),
        FilterSource(name: "Block Tracking Tools",
                     ...
                     free: false,
                     imageName: "hand.raised.slash.fill", color: Colors.redColor, whiteBlackList: false, fileName: "BlockTrackingTools"),
        FilterSource(name: "Block Irritating Element",
                     ...
                     free: false,
                     imageName: "flame.fill", color: Colors.yellowColor, whiteBlackList: false, fileName: "BlockIrritatingElement"),
        FilterSource(name: "Block Russian Language Websites",
                     ...
                     free: false,
                     imageName: "flag.fill", color: Colors.greenBlueColor, whiteBlackList: false, fileName: "BlockRussianLanguageWebsites"),
        FilterSource(name: "Block German Language Websites",
                     ...
                     free: false,
                     imageName: "flag.fill", color: Colors.purpleColor, whiteBlackList: false, fileName: "BlockGermanLanguageWebsites"),
        FilterSource(name: "Block Spanish & Portuguese Language Websites",
                     ...
                     free: false,
                     imageName: "flag.fill", color: Colors.greenColor, whiteBlackList: false, fileName: "BlockSpanishPortugueseLanguageWebsites"),
        FilterSource(name: "Block French Language Website",
                     ...
                     free: false,
                     imageName: "flag.fill", color: Colors.orangeColor, whiteBlackList: false, fileName: "BlockFrenchLanguageWebsite"),
        FilterSource(name: "White List", url: "", description: "", free: true, imageName: "whitelist", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
        FilterSource(name: "Black List", url: "", description: "", free: true, imageName: "blacklist", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
        FilterSource(name: "Privacy Policy", url: "", description: "", free: true, imageName: "", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
        FilterSource(name: "Terms of Use", url: "", description: "", free: true, imageName: "", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
    ...
    static let settingListData = [
        ...
        SettingListData(id: 2,
                        header: "Advanced",
                        settingData: [FilterSource(name: "Block Mobile Ads 2",
                                                   url: "https://gitlab.com/eyeo/adblockplus/adblock-plus-for-safari/-/raw/main/AdblockPlusSafari/Assets/easylist_content_blocker.json",
                                                   description: "Filter blocks mobile ad networks",
                                                   free: true,
                                                   imageName: "safari.fill", color: Colors.blueColor, whiteBlackList: false, fileName: "BlockMobileAds2"),
        ...
        SettingListData(id: 3,
                        header: "Filters",
                        settingData: [FilterSource(name: "White List", url: "", description: "", free: true, imageName: "whitelist", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
                                      FilterSource(name: "Black List", url: "", description: "", free: true, imageName: "blacklist", color: Colors.bgColor!, whiteBlackList: true, fileName: "")]),
        SettingListData(id: 4,
                        header: "Account Settings",
                        settingData: [FilterSource(name: "Privacy Policy", url: "", description: "", free: true, imageName: "", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
                                      FilterSource(name: "Terms of Use", url: "", description: "", free: true, imageName: "", color: Colors.bgColor!, whiteBlackList: true, fileName: ""),
                                      FilterSource(name: "Rate Us", url: "", description: "", free: true, imageName: "", color: Colors.bgColor!, whiteBlackList: true, fileName: "")
                        ])
    ]
