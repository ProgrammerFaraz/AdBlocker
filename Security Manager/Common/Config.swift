...
struct Config {
    struct App {
        static let appBundleId = "com.gsmith.adblockerSM"
        static let extensionBundleId = "com.gsmith.adblockerSM.Security-Manager-Blocker"
        static let appGroupId = "group.securityBlock4"
